...
const PlanBookTodo = ({planId, versionId, refreshList}) =>{  
...
const handleListShow = async (planId, planBookId, bookName, maxChapterNum, bookId) => {  

    if (planId == null || planBookId == null) return;
    ...
    try
    {
        const res = await readingBookApi.getBookLogs(planId, planBookId);    
        setTodoLogs(res);   
        setShowList(true);
    }
    catch(err)
                ...
                <div className="row g-3 align-items-center">
                    ...
                    <Modal show={show} onHide={handleClose} centered backdrop="static" keyboard={false}>
                        ...
                        <Modal.Body>
                            <Form>
                                ...
                                <Form.Group className="mb-3">
                                    <Form.Label>장 범위  
                                        {(formBook.maxChapterNum > 0) &&  <span className="text-danger small ms-2">({formBook.maxChapterNum} 장까지 읽음)</span>}
                        ...
                        <Modal.Footer>
                            ...
                            {!!formBook.planBookId  && <Button variant="danger" size="sm"><i className="bi bi-trash me-1"></i> 삭제</Button>}
            ...
            <div className="card-body">  
                    ...
                    <div className="row g-3" key={d.planBookId}>  
                        <div className="col-2">    
                            ...
                            onClick={() => handleListShow(d.planId, d.planBookId, d.nameKo, d.maxChapterNum, d.bookId)}> {d.nameKo} </a> 
                            <span className="text-danger small ms-2">({d.maxChapterNum}장)</span>
                        </div>
                        <div className="col-9">
...
<Modal show={showList} onHide={handleListClose} centered backdrop="static" keyboard={false} scrollable>
      ...
      <ListGroup variant="flush"> 
        {todoLogs.map((d, index) => (
          <ListGroup.Item 
            ...
            as="button" 
            type="button" 
            className="d-flex align-items-center border-0 px-4 py-3 custom-hover-item"
          > 
            <span className="flex-fill text-start fw-medium">{d.startChapter}장 ~ {d.endChapter}장</span>
  ...
  <Modal.Footer className="border-top-0">
    ...
    <Button variant="primary" className="px-4" onClick={handleListNew}>추가</Button>
  </Modal.Footer>
</Modal>
