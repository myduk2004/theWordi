    ...
    <div className="container px-4 mt-5 mb-5">
      <div className="row gx-4 justify-content-center">
        <div className="col-lg-9 mb-2">
          <h4>
            <i className="bi bi-alarm text-danger fs-3"></i> 계획
          </h4>
        </div>
                ...
                <div className="card-header text-bg-primary border-primary">
                  <div className="row g-3 align-items-center">
                    ...
                    <div className="col-md-3 text-end">
                      <button
                        type="button"
                        className="btn p-0 me-2 text-white"
                        onClick={handleShow}
                      >
                    ...
                    >
                        ...
                        <Form>
                          <Form.Group className="mb-3">
                            ...
                            <Form.Select
                              ...
                              style={
                                planForm.planId > 0
                                  ? { pointerEvents: "none", backgroundColor: "#f8f9fa" }
                                  : null
                              }
                            >
                          ...
                          <Form.Group className="mb-3">
                            <Form.Label>
                              제목{" "}
                              {errorPlan.title && (
                                <span className="text-danger ms-2 small">필수 입력입니다.</span>
                              )}
                            </Form.Label>
                            <Form.Control
                              type="text"
                      ...
                      <Modal.Footer>
                        ...
                        <Button variant="primary" onClick={onClickSavePlan}>
                          저장
                        </Button>
                    ...
                    return (
                      ...
                      >
                        <div className="row w-100 m-0 align-items-center">
                          ...
                          <span className="col-4 text-start small p-0">
                            {d.startDt} ~ {d.endDt}
                          </span>
